/**
 * @file vl53l8cx.cpp
 * @brief VL53L8CX Time-of-Flight sensor C++ wrapper implementation
 *
 * This file contains the implementation of the VL53L8CX C++ wrapper class.
 * It provides the concrete implementations for the sensor interface methods,
 * bridging the C++ API with the underlying C driver functions.
 *
...
/**
 * @brief Initialize VL53L8CX sensor
 * 
 * This function initializes the sensor by calling the underlying C API
 * initialization function. It must be called before any other operations.
 * 
...
/**
 * @brief Check if sensor is responsive
 * 
 * This function checks if the sensor is alive and responding to commands.
 * 
 * @return true if sensor is responsive, false otherwise
 */
...
/**
 * @brief Change I2C address of the sensor
 * 
 * @param i2c_address New I2C address (7-bit)
 * @return Status::OK on success, error code otherwise
 */
...
/**
 * @brief Get ranging data and copy to provided buffer
 * 
 * @param p_results Pointer to results data structure
 * @return Status::OK on success, error code otherwise
 */
...
/**
 * @brief Update internal results cache
 * 
 * @return Status::OK on success, error code otherwise
 */
...
/**
 * @brief Refresh settings from sensor
 * 
 * Reads current sensor settings (resolution, frequency, integration time, etc.)
 * and updates the internal configuration cache.
 * 
 * @return Status::OK on success, error code otherwise
 */
...
/**
 * @brief DCI read operation
 * 
 * @param data Buffer to store read data
 * @param index DCI index
...
/**
 * @brief DCI replace data operation
 * 
 * @param data Original data buffer
 * @param index DCI index
 * @param data_size Size of original data
 * @param new_data New data to insert
 * @param new_data_size Size of new data
 * @param new_data_pos Position to insert new data
 * @return Status::OK on success, error code otherwise
 */
...
/**
 * @brief Get distance measurement for specific zone and target
 * 
 * @param zone Zone index (0 to resolution-1)
 * @param target_idx Target index (0 to VL53L8CX_NB_TARGET_PER_ZONE-1)
 * @param ok Reference to boolean set to true if indices are valid
 * @return Distance in millimeters, 0 if disabled or invalid indices
 */
...
/**
 * @brief Get range sigma for specific zone and target
 * 
 * @param zone Zone index
 * @param target_idx Target index
 * @param ok Reference to boolean set to true if indices are valid
 * @return Range sigma in millimeters
 */
...
/**
 * @brief Get signal per SPAD for specific zone and target
 * 
 * @param zone Zone index
 * @param target_idx Target index
 * @param ok Reference to boolean set to true if indices are valid
 * @return Signal per SPAD value
 */
...
/**
 * @brief Get reflectance percentage for specific zone and target
 * 
 * @param zone Zone index
 * @param target_idx Target index
 * @param ok Reference to boolean set to true if indices are valid
 * @return Reflectance percentage (0-100%)
 */
...
/**
 * @brief Get target status for specific zone and target
 * 
 * @param zone Zone index
 * @param target_idx Target index
 * @param ok Reference to boolean set to true if indices are valid
...
/**
 * @brief Get ambient per SPAD for specific zone
 * 
 * @param zone Zone index
 * @param ok Reference to boolean set to true if zone is valid
 * @return Ambient per SPAD value
 */
...
/**
 * @brief Get number of targets detected in specific zone
 * 
 * @param zone Zone index
 * @param ok Reference to boolean set to true if zone is valid
 * @return Number of targets detected (0-4)
 */
...
/**
 * @brief Get number of SPADs enabled in specific zone
 * 
 * @param zone Zone index
 * @param ok Reference to boolean set to true if zone is valid
 * @return Number of SPADs enabled
 */
...
/**
 * @brief Get motion indicator value
 * 
 * @param motion_idx Motion index (0-31)
 * @param ok Reference to boolean set to true if index is valid
 * @return Motion indicator value
 */
...
/**
 * @brief Get motion global indicator 1
 * 
 * @param ok Reference to boolean set to true if motion indicator is enabled
 * @return Motion global indicator 1 value
 */
...
/**
 * @brief Get motion global indicator 2
 * 
 * @param ok Reference to boolean set to true if motion indicator is enabled
 * @return Motion global indicator 2 value
 */
...
/**
 * @brief Get number of detected motion aggregates
 * 
 * @param ok Reference to boolean set to true if motion indicator is enabled
 * @return Number of detected motion aggregates
 */
